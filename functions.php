...
if ( ! function_exists( 'photomania_setup' ) ) :
	...
	function photomania_setup() {
		...
		load_theme_textdomain( 'photomania', get_template_directory() . '/languages' );
...
function photomania_scripts() {
	...
	wp_enqueue_style( 'photomania-style', get_stylesheet_uri(), null, date( 'Ymd-Gis', filemtime( get_template_directory() . '/style.css' ) ) );
